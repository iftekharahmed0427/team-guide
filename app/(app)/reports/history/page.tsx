...
//
// Reads the real report_period / report_period_entry snapshots. Deleting a
// period cascades to every entry under it, so the trash button is admin-only and
// confirms first; deleteReportPeriod enforces the same rule server-side.
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between gap-[16px]">
                ...
                {isAdmin ? (
                  <DeletePeriod id={period.id} label={span} />
                ) : null}
              </div>
