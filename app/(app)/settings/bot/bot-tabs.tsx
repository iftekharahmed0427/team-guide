...
const TABS = [
  { label: "Connection", href: "/settings/bot" },
  { label: "Presence", href: "/settings/bot/presence" },
  { label: "Announcement", href: "/settings/bot/announcement" },
  { label: "Report channels", href: "/settings/bot/channels" },
];
