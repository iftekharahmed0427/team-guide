...
// /v2/payments - the payroll sheet, built from the "payments-page" Figma frame
// (node 56:4): the period/tickets/top-member stat row, the payroll card, and
// the hidden-members section underneath. Shell comes from app/v2/layout.tsx;
...
export default async function V2PaymentsPage() {
