...
// member's, on both. New audit is inert while v2 is a canvas.
export default function AuditsHeader({ total }: { total: number }) {
  return (
    <div className="flex items-center justify-between gap-[24px]">
      ...
      <button
        type="button"
        className="flex shrink-0 cursor-pointer items-center gap-[8px] rounded-[8px] bg-[#8fb0a7] px-[16px] py-[10px] text-[14px] font-semibold text-[#0e1217] transition-colors hover:bg-[#a3c0b8]"
      >
